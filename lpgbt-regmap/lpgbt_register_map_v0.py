...
class LpgbtRegisterMapV0:
    ...
    class EPRXLOCKFILTER:
        ...
        class EPRXLOCKTHRESHOLD:
            """Sets the lock threshold value of the instant lock low pass filter for ePortRx DLL's (default: 5)"""
        ...
        class EPRXRELOCKTHRESHOLD:
            """Sets the relock threshold value of the instant lock low pass filter for ePortRx DLL's (default: 5)"""
    ...
    class CLKGCONFIG0:
        ...
        class CLKGCALIBRATIONENDOFCOUNT:
            """Selects the VCO calibration race goal in number of clock cycles between refClk (refClkCounter) and vco_40MHz (vcoClkCounter) (2^(CLKGCalibrationEndOfCount[3:0]+1)); default: 12"""
    ...
    class CLKGCONFIG1:
        ...
        class CLKGCDRRES:
            """CDR's filter resistance; default: 1 when in RX/TRX mode, 0 when in TX mode"""
        ...
        class CLKGVCORAILMODE:
            """VCO rail mode; [0: voltage mode, fixed to VDDRX; 1: current mode, value selectable using CLKGVcoDAC (default)]"""
    ...
    class CLKGPLLRES:
        ...
        class CLKGPLLRESWHENLOCKED:
            """PLL's filter resistance when PLL is locked [R = 1/2 * 79.8k / CONFIG] Ohm; default: 4; set to 0 if RX or TRX mode"""
        ...
        class CLKGPLLRES:
            """PLL's filter resistance when PLL is locking [R = 1/2 * 79.8k / CONFIG] Ohm; default: 4; set to 0 if RX or TRX mode"""
    ...
    class CLKGPLLINTCUR:
        ...
        class CLKGPLLINTCURWHENLOCKED:
            """PLL's integral current path when in locked state [0 : 1.1 : 8] uA; default: 5"""
        ...
        class CLKGPLLINTCUR:
            """PLL's integral current path when in locking state [0 : 1.1 : 8] uA; default: 5"""
    ...
    class CLKGPLLPROPCUR:
        ...
        class CLKGPLLPROPCURWHENLOCKED:
            """PLL's proportional current path when in locked state [0 : 5.46 : 82] uA; default: 5"""
        ...
        class CLKGPLLPROPCUR:
            """PLL's proportional current path when in locking state [0 : 5.46 : 82] uA; default: 5"""
    ...
    class CLKGCDRFFPROPCUR:
        ...
        class CLKGCDRFEEDFORWARDPROPCURWHENLOCKED:
            """CDR's proportional feed forward current path when in locked state [0 : 5.46 : 82] uA; default: 5"""
        ...
        class CLKGCDRFEEDFORWARDPROPCUR:
            """CDR's proportional feed forward current path when in locking state [0 : 5.46 : 82] uA; default: 5"""
    ...
    class CLKGFLLINTCUR:
        ...
        class CLKGFLLINTCURWHENLOCKED:
            """CDR's frequency detector charge pump when in locked state [0 : 5.46 : 82] uA; default: 0"""
    ...
    class CLKGOVERRIDECAPBANK:
        ...
        class CLKGCAPBANKSELECT:
            """Selects the capacitor bank value for the VCO [check attached table] (only when CLKGCapBankOverrideEnable is 1); default: n/a"""
    ...
    class CLKGWAITTIME:
        ...
        class CLKGWAITCDRTIME:
            """ljCDR state machine waiting for lock, RX/TRX mode, (16'h0001 << waitCDRTime); (only when CLKGDisableFrameAlignerLockControl == 1); default: 8"""
        ...
        class CLKGWAITPLLTIME:
            """ljCDR state machine waiting for lock, TX mode, (16'h0001 << waitPLLTime); (only when lfEnable == 0); default: 8"""
    ...
    class CLKGLFCONFIG0:
        ...
        class CLKGLOCKFILTERENABLE:
            """Enables the lock filter on the instant lock signal; only in TX mode [0 - disable, 1 enable]; default: 1"""
        ...
        class CLKGLOCKFILTERLOCKTHRCOUNTER:
            """Sets the lock threshold value of the instant lock low pass filter (16'h0001 << lfLockThrCounter); only in TX mode; default: after SEU"""
    ...
    class CLKGLFCONFIG1:
        ...
        class CLKGLOCKFILTERRELOCKTHRCOUNTER:
            """Sets the relock threshold value of the instant lock low pass filter (16'h0001 << lfReLockThrCounter); only in TX mode; default: after SEU"""
        ...
        class CLKGLOCKFILTERUNLOCKTHRCOUNTER:
            """Sets the unlock threshold value of the instant lock low pass filter (16'h0001 << lfUnLockThrCounter); only in TX mode; default: after SEU"""
    ...
    class FAMAXHEADERFOUNDCOUNT:
        ...
        class FAMAXHEADERFOUNDCOUNT:
            """The number of consecutive valid frame headers that have to be detected before frame lock is assumed."""
    ...
    class FAMAXHEADERFOUNDCOUNTAFTERNF:
        ...
        class FAMAXHEADERFOUNDCOUNTAFTERNF:
            """The number of consecutive detected valid headers to be found to clear
            the invalid frame count. The reset can happen only if the number of detected invalid headers does not exceed the FAMaxHeaderNotFoundCount[7:0].
            """
    ...
    class FAMAXHEADERNOTFOUNDCOUNT:
        ...
        class FAMAXHEADERNOTFOUNDCOUNT:
            """The maximum number of invalid headers (consecutive or not) that can be received before the frame is considered misaligned."""
    ...
    class FAFAMAXSKIPCYCLECOUNTAFTERNF:
        """Frame aligner configuration register."""
        ...
        @staticmethod
        def __str__():
            return "FAFAMaxSkipCycleCountAfterNF"

        @staticmethod
        def __int__():
            return 0x0032

        class FAMAXSKIPCYCLECOUNTAFTERNF:
            """The maximum number of skip cycles (consecutive or not) that can be issued CRD is considered to be unlocked."""
    ...
    class PSDLLCONFIG:
        ...
        class EPRXUNLOCKTHRESHOLD:
            """Sets the unlock threshold value of the instant lock low pass filter for ePortRx DLL's (default: 5)"""
    ...
    class EPRXDLLCONFIG:
        ...
        class EPRXENABLEREINIT:
            """Allow re-initialization in ePortRxGroup when the tuning is out of range."""
    ...
    class FORCEENABLE:
        ...
        class TESTCLKFORCEENABLE:
            """Enable the test clock input pad regardless of the operation mode."""
        ...
        class I2CMCLKALWAYSENABLE:
            """I2C masters clock always enable (disable clock gating)."""
    ...
    class REFCLK:
        ...
        class TESTCLKSETCM:
            """Enable common mode generation for TSTCLKN/P input pads."""
    ...
    class RESETCONFIG:
        ...
        class RESETOUTDRIVESTRENGTH:
            """Reset out pin driving strength."""
    ...
    class EPRXECCONTROL:
        ...
        class EPRXECTRACKMODE:
            """Sets the phase tracking mode for EC channel
    ...
    class POWERUP2:
        ...
        class UPDATEENABLE:
            """When asserted, the power up state machine copies the values from fuses to configuration registers during power. Please refer :ref:`configuration` for more details."""
    ...
    class EPRXTRAINEC6:
        ...
        class EPRXECTRAIN:
            """Initialize phase training for EC channel."""
    ...
    class ADCMON:
        ...
        class VDDPSTMONENA:
            """Enable resistive divider for VDDPST probing."""
    ...
    class EOMCONFIGH:
        ...
        class EOMENDOFCOUNTSEL:
            """Amount of refClk clock cycles (40 MHz cycles) the EOM counter is gated (2^(selEndOfCount+1))"""
    ...
    class DPDATAPATTERN3:
        ...
        class DPDATAPATTERN:
            """Bits 31:24 of the canst pattern."""
    ...
    class DPDATAPATTERN2:
        ...
        class DPDATAPATTERN:
            """Bits 23:16 of the canst pattern."""
    ...
    class DPDATAPATTERN1:
        ...
        class DPDATAPATTERN:
            """Bits 15:8 of the canst pattern."""
    ...
    class RST2:
        ...
        class SKIPFORCE:
            """Toggling this bit allows to issue a skip cycle command (equivalent to the one issued by the frame aligner).
        ...
        class RESETOUTFORCEACTIVE:
            """As long as this bit is set low, the ``resetOut`` signal is active (low level)."""
    ...
    class POWERUP3:
        ...
        class PUSMSTATEFORCED:
            """Selects state of the power up state machine when ``STATEOVRD`` pin is asserted or ``PUSMForceState`` bit is asserted.
            For more details refer to :ref:`powerUpStateMachine` and :ref:`STATEOVRD`)
    ...
    class CONFIGPINS:
        ...
        class CONFIGSELECT:
            """State of ``SC_I2C`` pin. The function of the pin is described in :ref:`SC_I2C`."""
        ...
        class VCOBYPASS:
            """State of the `VCOBYPASS` pin. The function of the pin is described in :ref:`VCOBYPASS`."""
        ...
        class STATEOVERRIDE:
            """State of the ``STATEOVRD``. The function of the pin is described in :ref:`STATEOVRD`. `"""
    ...
    class I2CM0CTRL:
        ...
        class I2CM0CTRL:
            """Contents of control register written by user"""
    ...
    class CLKGSTATUS3:
        ...
        class CLKG_LFLOSSOFLOCKCOUNT:
            """Lock filter loss of lock (increases when lock filter's state goes lfConfirmUnlockState -> lfUnLockedState); only in TX mode"""
    ...
    class DLDPFECCORRECTIONCOUNTH:
        ...
        @staticmethod
        def __str__():
            return "DLDPFecCorrectionCountH"
    ...
    class DLDPFECCORRECTIONCOUNTL:
        ...
        @staticmethod
        def __str__():
            return "DLDPFecCorrectionCountL"
    ...
    class ROM:
        ...
        class ROMREG:
            """All read requests for this register should yield value `0xA5`."""
    ...
    class PUSMACTIONS:
        ...
        class PUSMPLLTIMEOUTACTION:
            """This flag is set if the PLL timeout action has be executed since the last chip reset."""
        ...
        class PUSMDLLTIMEOUTACTION:
            """This flag is set if the DLL timeout action has be executed since the last chip reset."""
        ...
        class PUSMCHANNELSTIMEOUTACTION:
            """This flag is set if the wait for channels locked timeout action has be executed since the last chip reset."""
        ...
        class PUSMBROWNOUTACTION:
            """This flag is set if the brownout action has be executed since the last chip reset."""
        ...
        class PUSMPLLWATCHDOGACTION:
            """This flag is set if the PLL watchdog action has be executed since the last chip reset."""
        ...
        class PUSMDLLWATCHDOGACTION:
            """This flag is set if the DLL watchdog action has be executed since the last chip reset."""
    ...
    class TOVALUE:
        ...
        class TOVAL:
            """Current value of all test outputs"""
    ...
    class FASTATE:
        ...
        class FASTATE:
            """State of the frame aligner state machine. TODO add the description."""
    ...
    class FACOUNTER:
        ...
        class FACOUNTER:
            """Interpretation of this field depends on the current state."""
